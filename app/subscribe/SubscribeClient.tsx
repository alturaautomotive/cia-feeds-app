        ...
        <div className="space-y-1">
          <div className="flex">
            <input
              ...
              className="border border-gray-300 rounded-md px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 flex-1"
            />
            <button
